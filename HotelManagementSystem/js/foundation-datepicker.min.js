! function(a) {
    ...
    c.prototype = {
        ...
        fillMonths: function() {
            for (var a = "", b = 0; b < 12;) a += '<span class="month">' + d[this.language].monthsShort[b++] + "</span>";
        ...
        fill: function() {
            if (null != this.date && null != this.viewDate) {
                ...
                f -= 1;
                for (var y = -1; y < 11; y++) u += '<span class="year' + (y == -1 || 10 == y ? " old" : "") + (A == f ? " active" : "") + (f < k || f > m ? " disabled" : "") + '">' + f + "</span>", f += 1;
                C.html(u)
            }
        },
    ...
    var d = a.fn.fdatepicker.dates = {
        ...
        e = {
            ...
            formatDate: function(b, c, e) {
                ...
                for (var b = [], g = a.extend([], c.separators), h = 0, i = c.parts.length; h < i; h++) g.length && b.push(g.shift()), b.push(f[c.parts[h]]);
                return b.join("")
            },
